...
// Use __DIR__ to ensure correct path regardless of where script is called from
...
Submitted: " . date('Y-m-d H:i:s') . "
    ...
    $autoReply->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; // Use SSL for port 465
    $autoReply->Port = 465; // Gmail SSL port
    ...
    echo json_encode([
        ...
        'error' => $errorDetails // Remove this in production for security
    ]);
}
?>
